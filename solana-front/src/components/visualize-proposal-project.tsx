...
export function VisualizeProposalProject( {authorityPda, projectIdx}: VizualizeProjectForm) {
  const budgetList = ["Less than $50 US", "$50 - $150 US", "$150 - $550 US", "$550 - $1500 US","$1500 - $2500 US", "Over $3500 US" ]
  const budgetIcons = ["🙂", "🤗", "😎", "💪🏽", "🦾", "🤖", "👽"]

  const { fetchProject, projectFilter, loadingFetchProject } = useProjects()
  
  fetchProject({authorityPda, projectIdx})
